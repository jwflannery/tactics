...
namespace CreativeSpore.SuperTilemapEditor
{
    public static class TilemapUtilsEditor
    {
        ...
        /*
        static public Texture2D CreateTexture2DFromTilemaps(List<STETilemap> tilemapList)
        {
            //sort tilemaps by sorting layer, sorting order, and Z position
            tilemapList.OrderBy(t => SortingLayer.GetLayerValueFromID(t.SortingLayerID)).
        }*/
        ...
        public static Texture2D CreateTilemapGroupPreviewTexture(STETilemap tilemap, TilemapGroup tilemapGroup = null)
        {
            ...
            previewCamera.orthographicSize = (previewCamera.pixelRect.height) / (2f * pixelToUnits); //TODO: restore camera value
